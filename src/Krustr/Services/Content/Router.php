...
class Router {
	...
	public function initContent()
	{
		...
		{
			Route::get($channel->resource,             array('as' => 'public.channel.'.$channel->resource.'.collection', 'uses' => 'Krustr\Services\Content\Finder@entryCollection'));
			Route::get($channel->resource . '/{slug}', array('as' => 'public.channel.'.$channel->resource.'.entry',      'uses' => 'Krustr\Services\Content\Finder@entry'));
		}
